                ...
                if(data.length != 0){
                    ...
                    data.map(item =>{
                        ...
                        let html = '<li class="">'
                            ...
                            + '</div>'
                            + '<div class="info-box">'
                            + '<div class="title"><a href="#"><span title="'+ artistNameJSON[locale] + '">' + artistNameJSON[locale] + '</span></a>'
                            // + '<div class="title"><a href="#"><span>' + titleJSON[locale] + '</span></a>'
                            + '</div>'
                            + '<div class="desc"><a href="#"><span title="'+ titleJSON[locale] + '" >' + titleJSON[locale] + '</span></a></div>'
