...
<c:set var="vat" value="18182" scope="page"/>
...
<br>
<br>
<form name="payForm" method="post" action="/customer/niceRegularResult" accept-charset="utf-8" >
      ...
      <tr>
        ...
        <td ><table width="562" border="0" cellspacing="0" cellpadding="0" class="talbeBorder" >
		  ...
		  <tr>
            ...
            <td id="borderBottom" ><input name="GoodsName" type="text" value="서울옥션 - 정회원"/></td>
          </tr>
          <tr>
