											...
											<div class="result_auction_img grid_result_auction_img" oncontextmenu="return false" onselectstart="return false" ondragstart="return false" onkeydown="return false" align="center">
												...
												<span ng-if="!is_login">
													<span ng-if="sale_status=='ING'">
														...
														<!-- YBK.출품.이미지게시X -->
														<a ng-if="lot.STAT_CD != 'reentry' && lot.IMG_DISP_YN != 'Y'" ng-href="#" onClick="alert('로그인 후 확인할 수 있습니다.\n Please login for use.'); location.href='/login';" rel="gallery1" style="width:auto; height: auto; max-width: 100px; max-height: 100px;">
															<img ng-src="/images/bg/no_image.jpg" style="width:auto; height: auto; max-width: 100px; max-height: 100px;" />
														</a>
													</span>
													<span ng-if="sale_status!='ING'">
	                                            	...
	                                            	<div class="es_price">   
                                                        ...
                                                        <ul ng-if="lot.EXPE_PRICE_INQ_YN != 'Y' && (((lot.EXPE_PRICE_TO_JSON[base_currency]) != 0 && (lot.EXPE_PRICE_TO_JSON[base_currency]) != null) || ((lot.EXPE_PRICE_FROM_JSON[base_currency]) != 0 && (lot.EXPE_PRICE_FROM_JSON[base_currency]) != null))">
                                                            ...
                                                            <li class="es_price_right" style="font-size: 12px; line-height: 20px;"> 
                                                                <div class="krw Price_inqury" ng-if="lot.EXPE_PRICE_INQ_YN == 'Y'"><spring:message code="label.auction.detail.Request" /></div>   
