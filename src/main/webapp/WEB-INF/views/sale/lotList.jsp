...
//  		} 
 		$d = {"baseParms":{}, 
 				...
 				{"actionID":"sale_list_paging", "actionType":"select" , "tableName": "SALES", "parmsList":[{"sale_kind_cd":$scope.sale_kind_cd, "status":$scope.sale_status, "sale_outside_yn": $scope.sale_outside_yn, "sort_by":"SALENOASC", "from":0, "rows":3}]}
 			]};   
