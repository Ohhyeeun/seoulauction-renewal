 	   	...
 	   	common.callActionSet($d, function(data, status) { 
 	 		...
 	 		if(FROM_DT > S_DB_NOW && 
 				...
 				|| (['online','online_zb'].indexOf($scope.sale.SALE_KIND_CD) > -1 && END_DT < S_DB_NOW)){		//$scope.sale.SALE_KIND_CD == 'online' 수정. 2019.12.12 YDH
 	 			...
 	 			if(is_login == "false"){
 	 				alert("해당 경매는 마감되었습니다. 로그인 해주시기 바랍니다.");
 	 				window.close();
 	 			}
 	 		}
								...
								<div class="m_ex_title"> 
									<div class="title"> 
	                                    ...
	                                    <div class="m_only" style="padding:4px; margin-top:10px;"> 
                                            ...
                                            <!-- 메이저 경매 온라인응찰 버튼(오픈시처리)   
                                            <span class="btn_style01 orange01"  ng-if="custInfo.MEMBERSHIP_YN == 'Y' || custInfo.FORE_BID_YN == 'Y' || custInfo.EMP_GB == 'Y'"><button type="button" align="center" scrolling="no" onClick="window.open('${contextPath}/service/page?view=bidLivePop')";><span ng-if="locale=='ko'">Live 응찰</span><span ng-if="locale!='ko'">Live biding</span></button></span>
                                            </div> -->  
                                            <!-- 메이저 경매 온라인응찰 버튼(오픈시처리) 
                                            <span class="btn_style01 orange01"  ng-if="custInfo.MEMBERSHIP_YN != 'Y' && custInfo.FORE_BID_YN != 'Y' && custInfo.EMP_GB != 'Y'"><button type="button" align="center" scrolling="no" onClick="alert('정회원만 응찰 가능합니다.')"><span ng-if="locale=='ko'">Live 응찰</span><span ng-if="locale!='ko'">Live biding</span></button></span> 
                                            </div> -->       
											...
											<div class="livebid_page" ng-if="sale_status == 'ING' && nowTime < liveEnd">          
			                                	<div class="livebid_pageback">   
			                                		...
			                                		<span>    
				                                		...
				                                		<a ng-if="is_login == 'true' && custInfo.MEMBERSHIP_YN == 'Y' && padd_no == 0" class="livebid_page_btn" href="" alt="온라인 실시간 신청" ng-click="paddleAdd(sale.SALE_NO)">     
				                                			<c:if test="${locale == 'ko'}">  
				                                				<span class="livebid_pageback_txt">온라인 실시간 신청</span>  
				                                			</c:if>    
				                                			<c:if test="${locale != 'ko'}">    
							...
							<div class="sub lotlist_memobox">
                                ...
                                <dl style="padding-top:15px; padding-bottom:20px;">  
                                    <div class="btns">   
										...
										<!-- 메이저경매 온라인응찰 버튼(오픈시처리)     
		                                      <span class="btn_style01 orange01">  
		                                              <button type="button" ng-if="custInfo.MEMBERSHIP_YN == 'Y' || custInfo.FORE_BID_YN == 'Y' || custInfo.EMP_GB == 'Y'" align="center" scrolling="no" onClick="window.open('${contextPath}/service/page?view=bidLivePop')"; ><span ng-if="locale=='ko'">Live 응찰</span><span ng-if="locale!='ko'">Live biding</span></button>
												<button type="button" ng-if="custInfo.MEMBERSHIP_YN != 'Y' && custInfo.EMP_GB != 'Y' && custInfo.FORE_BID_YN != 'Y'" align="center" scrolling="no" onClick="alert('정회원만 응찰 가능합니다.')" ><span ng-if="locale=='ko'">Live 응찰</span><span ng-if="locale!='ko'">Live biding</span></button>
										</span> -->   
...
<!-- 												</a> -->
	                                ...
	                                <div class="livebid_page" ng-if="sale_status == 'ING' && liveCheckDt >= liveStartDt">            
	                                	<div class="livebid_pageback">         
	                                		<!-- 경매 당일 응찰하기 자동생성 -->          
	                                		<span>  
	                                			<a ng-if="custInfo.MEMBERSHIP_YN == 'Y'" class="livebid_page_btn" target="blank" href="/service/page?view=bidLive_memberNew&sale_no={{sale.SALE_NO}}" alt="온라인 실시간 응찰">
	                                				<c:if test="${locale == 'ko'}"><span class="livebid_pageback_txt">온라인 실시간 응찰<p ng-if="padd_no > 0">PADD NO. {{padd_no}}</p></span></c:if> 
                              						<c:if test="${locale != 'ko'}"><span class="livebid_pageback_txt" style="font-size: 16px;">Online live bid<br><p ng-if="padd_no > 0">PADD NO. {{padd_no}}</p></span></c:if>    
	                                			</a> 
	                                			<a ng-if="custInfo.MEMBERSHIP_YN != 'Y'" class="livebid_page_btn" target="blank" href="/service/page?view=bidLive_all&sale_no={{sale.SALE_NO}}" alt="온라인 실시간 응찰">
                              						<c:if test="${locale == 'ko'}"><span class="livebid_pageback_txt">온라인 실시간 응찰</span></c:if> 
                              						<c:if test="${locale != 'ko'}"><span class="livebid_pageback_txt" style="font-size: 16px;">Online live bid</span></c:if>      
												</a> 
	                                		</span>   
    ...
    <!--CATEGORY-->			<span ng-repeat="cate in category" class="standard" flex="50">
                            ...
                            <span ng-if="is_login == 'false'"> 
                            	<span ng-if="locale=='ko'" onClick="alert('로그인 후 확인할 수 있습니다.\n Please login for use.')" checklist-model="fav_cds_list"><a href="#" >관심작품보기</a></span>
                            </span> 
                            <span ng-if="is_login == 'true'">
                            	<span ng-if="locale=='ko'" ng-click="fav_toggle( 1 , fav_selected)" checklist-model="fav_cds_list"><a href="#" >관심작품보기</a></span>
                            </span>    -->   
                            <!-- 관심작품보기 리스트 page -->   
							<div class="wish_btn wish_btn_right">     
								<span ng-if="is_login == 'false'">        
	                            	<span class="wish_btnko" ng-if="locale == 'ko'" onClick="alert('로그인 후 확인할 수 있습니다.\n Please login for use.')" checklist-model="fav_cds_list" title="관심작품 보기">        
	                            ...
	                            <span ng-if="is_login == 'true'">      
	                            	<span class="wish_btnko" ng-if="locale == 'ko'" ng-click="fav_toggle( 1 , fav_selected)" checklist-model="fav_cds_list" title="관심작품 보기">           
		                            	<span class="grid_wish_btn wish_btn_list">   
		                            	</span>        
		                            	<span style="font-size: 12px; font-weight: bold; color: #999; vertical-align:middle;">      
		                            		관심작품 보기   
