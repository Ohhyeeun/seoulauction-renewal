    ...
    <div class="innerfooter">
        <section class="flex_wrap footer_menubox">
            ...
            <ul class="snsbox_icon">
                <li><a href="https://www.youtube.com/user/SeoulAuction" class="sns-icon sns-icon01"></a></li>
                <li><a href="https://www.instagram.com/seoulauction" class="sns-icon sns-icon02"></a></li>
                <li><a href="https://www.facebook.com/seoulauction" class="sns-icon sns-icon03"></a></li>
                <li><a href="http://blog.naver.com/PostList.nhn?blogId=s_auction" class="sns-icon sns-icon04"></a></li>
                <li><a href="https://pf.kakao.com/_yxiUyxl" class="sns-icon sns-icon05"></a></li>
            </ul>
        </section>
