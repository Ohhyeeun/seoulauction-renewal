        ...
        <div class="innerfooter-familybox">
            <div class="Familysite-selectbox">
                ...
                <ul class="familyselect">
                    <li><a href="javascript:void(0);" onclick="openWebBrowser('https://printbakery.com');" target="_blank">Print Bakery</a></li>
                    <li><a href="javascript:void(0);" onclick="openWebBrowser('https://www.auctionblue.com/index');" target="_blank">Auction Blue</a></li>
                    <li><a href="javascript:void(0);" onclick="openWebBrowser('https://sotwo.com/');" target="_blank">SOTOW</a></li>
                </ul>
            </div>
        </div>
        <div class="innerfooter">
            <section class="flex_wrap footer_menubox">
                ...
                <ul class="snsbox_icon">
                    <li><a target="_blank" href="javascript:void(0);" onclick="openWebBrowser('https://www.youtube.com/user/SeoulAuction');" class="sns-icon sns-icon01"></a></li>
                    <li><a target="_blank" href="javascript:void(0);" onclick="openWebBrowser('https://www.instagram.com/seoulauction');" class="sns-icon sns-icon02"></a></li>
                    <li><a target="_blank" href="javascript:void(0);" onclick="openWebBrowser('https://www.facebook.com/seoulauction');" class="sns-icon sns-icon03"></a></li>
                    <li><a target="_blank" href="javascript:void(0);" onclick="openWebBrowser('http://blog.naver.com/PostList.nhn?blogId=s_auction');" class="sns-icon sns-icon04"></a></li>
                    <li><a target="_blank" href="javascript:void(0);" onclick="openWebBrowser('https://pf.kakao.com/_yxiUyxl');" class="sns-icon sns-icon05"></a></li>
                </ul>
            </section>
