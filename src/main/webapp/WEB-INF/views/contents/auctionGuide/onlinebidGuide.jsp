			...
			<div class="contents_wrap">
				<div class="contents">
					<div class="tit_h2 border">
						<h2>온라인 경매 안내</h2>
						<p style="line-height:30px; font-size:16px;">서울옥션이 국내 최초로 시작한 온라인 경매는 폭넓은 작가군과 합리적인 가격의 작품을 선보입니다.<br/>
					...
					<div class="num_cont_wrap">
						<div class="num_cont bg106">
							...
							<div class="tit_h3">
								<h3>회원가입</h3>
								<p style="line-height:30px; font-size:16px;">서울옥션 미술품 온라인 경매는 별도의 가입비 없이 홈페이지에서 회원 가입 후 경매 전 인증을 마치면 누구나 참여 가능합니다. <br/> 
                                <a href="/currentAuction?sale_kind=online_only" class="btn_main_more sky" style="width:230px;margin-top:10px; padding-bottom:15px; margin-bottom:10px;">현재 진행중인 온라인경매 바로가기</a>  <br/> 
						...
						<div class="num_cont bg102">
							...
							<div class="tit_h3">
								<h3>프리뷰 관람</h3>
								<p style="line-height:30px; font-size:16px;">프리뷰는 경매에 출품된 모든 작품을 감상하고 상태를 확인할 수 있는 전시회입니다. <br/> 
                                프리뷰 관람은 경매 응찰과 관계없이 누구나 무료로 관람이 가능합니다. <br/> 
                                프리뷰 전시장에서 스페셜리스트에게 요청하시면 경매 작품에 대한 안내를 받으실 수 있습니다. <br/> 
                                프리뷰 일정은 문자, SNS, 홈페이지, 도록(초대장) 등을 통해 공지 됩니다. <br/> 
                                </p>
							</div>
						...
						<div class="num_cont join_guide guide02 bg108">
							...
							<div class="tit_h3">
                                ...
                                &bull;&nbsp;프리뷰 전시 기간 동안 홈페이지를 통해 응찰 가능하며, 경매 마감 시간부터 lot 번호 순차적으로 마감됩니다. <br/>
									...
									<div>
										<div class="inner">										
											<div class="bg_img bg23">
												<div class="title">1회응찰 / Bid</div>
												<p>주어진 금액에 따라 1회씩 수동응찰</p>
											</div>
										</div>
									</div>
									<div>
										<div class="inner">
											<div class="bg_img bg23">
                                                ...
                                                *자동응찰의 경우 상대 응찰자가 없으면 최소 금액으로 낙찰됩니다. </p>
											</div>										
										</div>
									</div>
								</div>
			...
			<!------------------- // 온라인 경매 호가단위 테이블 추가 (em) ------------->
						...
						<div class="num_cont bg107">
							...
							<div class="tit_h3">
                                ...
                                <p style="line-height:30px; font-size:16px;">경매 낙찰은 시작 후 최고가를 제시한 응찰자에게 경매작품이 낙찰되며, 자동응찰 > 수동 응찰 순으로 우선적으로 낙찰 기회가 주어집니다.<br/>
                                ...
                                <p style="line-height:30px; font-size:16px;">낙찰 시, 이메일로 낙찰확인서가 발송 됩니다. 혹은 홈페이지 로그인 > 회원정보 > 경매거래내역 > 구매내역에서 낙찰 금액 및 수수료를 확인 하실 수 있습니다. <br/>
                                ...
                                <p style="line-height:30px; font-size:16px;">낙찰받은 작품에 대한 총 구매대금 결제방법은 아래와 같습니다.<br/>
                                  ▶계좌 입금<br/>
                                  <strong>(온라인 경매)</strong> 우리은행 1005-200-281649 (주)서울옥션 (입금 후 전화 확인 바랍니다)<br/> 
                                  <strong>(제로베이스 경매)</strong> 우리은행 1005-403-971518 (주)서울옥션 (입금 후 전화 확인 바랍니다)<br/>     
                                  ...
                                  * 계좌입금 시 입금 메모란에 실제 낙찰자의 이름을 명시해 주십시오. 입금자와 낙찰자의 이름이 일치하지 않을 경우, 입금확인이 어려울 수 있으며, 이에 대한 불이익은 서울옥션에서 책임지지 않습니다.<br/><br/>
                                  ...
                                  낙찰자는 로그인 후, ACCOUNT -> 온라인경매거래목록 -> 구매내역에서 낙찰내역 확인과 결제를 진행해 주시기 바랍니다. <br/><br/>
                                  ▶방문결제<br/>
							...
							<div class="box_style08">
								<div class="list_style01">
									<ul style="margin-left:20px;">
                                        ...
                                        <li style="font-weight:600; font-size:16px; line-height:24px;">※ 단, 경매에 따라 무료배송 진행이 아닌, 유료배송으로 진행 될 수도 있습니다.</li>
									</ul>
								</div>
							</div>
                        </div>
