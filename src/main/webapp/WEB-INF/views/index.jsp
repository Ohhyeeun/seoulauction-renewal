...
<body>  
                        ...
                        <ul class="subGnbmenu">  
                            ...
                            <li class="subGnbmenu-tit m-ver">  
                                <ul class="mobile-utility">
                                    <li><a href="#">로그인</a></li> 
                                    <li><a href="#" class="member.off">회원가입</a><a href="#" class="member">마이페이지</a></li>   
            ...
            <section class="topsearch-box">   
                ...
                <form action="" class="scroll_none">
                    <fieldset class="topsearch"> 
                        ...
                        <input onkeydown="searchFilter()" type="text" class="topsearch-text pc-ver" placeholder="검색어를 입력해주세요."><button type="submit" class="topsearch-btn pc-ver"></button>
    ...
    <section class="main-contents resize_h"> 
                        ...
                        <figure class="visual_img"> 
                            ...
                            <figurecaption class="visual_caption">    
                                ...
                                <div class="visual_btn">
                                    <a href="#" class="commonbtn visual-commonbtn btn-bg-b">작품보기</a>
                ...
                <article class="flex_wrap article-contents">
                    ...
                    <div class="newsletter-box">
                        ...
                        <div class="flex_wrap newsletter-btnbox">
                            <button type="button" class="commonbtn btn-border-3">구독하기</button> 
