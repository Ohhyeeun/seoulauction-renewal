			...
			<fieldset>
				<div class="tbl_style01 m_tbl_z003 mt15">
					<table>
							...
							<td>
								<div class="fl_wrap type02">
									<div class="input_phone">
										<input type="text" style="ime-mode:disabled;" ng-model="form_data.phone" onkeypress="phoneNumber(this)" 
											name="phone" class="tac phone_number phone_number01" placeholder="휴대폰번호" maxlength=11 tabindex="14"/>
										...
										<span class="tbl_txt" id="auth_exists" ng-style="{'color': 'red', 'font-weight': 'bold'}"></p>
										</span>
									</div>
								</div>
							</td>
						...
						<tr>
							<th scope="row" style="width:100px;"><span class="ico_essen"><span class="hidden">필수입력</span></span></th>
							<td>
								<div class="fl_wrap type02">
