                                                                ...
                                                                <div class="cont-wrap">
                                                                    ...
                                                                    <dl>
                                                                        ...
                                                                        <span class="pay complete" ng-click="academyPayHis({'parent':this, 'academy':art});">결제완료</span>
                                                                         <button class="btn btn_gray_line btn_sm"  type="button" data-id="{{art.PG_TRANS_ID}}" data-type="0" ng-if="art.PAY_METHOD_ID == 'card' && art.receipt == 'Y'" onclick="receiptPopup(this)"><span>카드영수증</span></button>
