                                                            ...
                                                            <dt>
                                                                <div class="title-area">
                                                                    ...
                                                                    <div class="desc tb1">
                                                                        ...
                                                                        <span ng-if="pl[1][0].ONLINE_YN == 'Y'">{{pl[1][0].TO_DT}} 순차마감</span>
                                                                        <span ng-if="pl[1][0].ONLINE_YN == 'N'">{{pl[1][0].TO_DT}}</span>
                                                                    </div>
                                                                </div>
                                                            </dt>
                                                                ...
                                                                <div class="item-ea-inner">
                                                                            ...
                                                                            <div class="text-area">
                                                                                ...
                                                                                <div class="sub-box">
                                                                                    ...
                                                                                    <div class="sub-li">
					                                                                    ...
					                                                                    <span ng-bind="StringToJson(data.MAKE_YEAR_JSON).ko" ng-show="StringToJson(data.MAKE_YEAR_JSON).ko !== undefined"></span>
					                                                                    <span ng-show="(StringToJson(data.MAKE_YEAR_JSON).ko === undefined && change_size)">ㅤ</span>
                                                                                    </div>
                                                                                    <!-- //[0613]재질/사이즈로 수정 -->
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="pay-infobox">
                                                                        ...
                                                                        <!-- 온라인 가상계좌 외 결제대기상태 or 가상계좌 기간이 끝났을 때 -->
                                                                            <button class="btn btn_point" type="button" ng-click="goPay(data.SALE_NO, data.LOT_NO)" ng-if="data.ONLINE_YN == 'Y' && data.PAID_CNT == 0 && data.VBANK_EXP_DT_CLOSE_YN !='N'"><span>결제하기</span></button>
                                                                        
                                                                        <!-- 라이브 결제대기상태 or 부분납 상태-->
                                                                            <button class="btn btn_gray_line" type="button" ng-if="(data.ONLINE_YN == 'N' && data.PAID_CNT == 0) || (data.PAID_CNT > 0 && getPayTotal(data.BID_PRICE, data.LOT_FEE_JSON).price > data.PAY_PRICE)" ng-click="payInfoPopup()" ><span>결제 안내</span></button>
                                                                        
                                                                        <!-- 온라인 부분납 제외 결제완료 일 경우만 영수증 버튼 노출-->
                                                                            <button class="btn btn_gray_line" type="button" data-id="{{data.PG_TRANS_ID}}" data-type="0" ng-if="data.ONLINE_YN == 'Y' && data.PAID_CNT == 1 && getPayTotal(data.BID_PRICE, data.LOT_FEE_JSON).price == data.PAY_PRICE && data.receipt_card == 'Y' && data.PG_TRANS_ID" onclick="receiptPopup(this)"><span>카드영수증</span></button>
                                                                            <button class="btn btn_gray_line" type="button" data-id="{{data.PG_TRANS_ID}}" data-type="1" ng-if="data.ONLINE_YN == 'Y' && data.PAID_CNT == 1 && getPayTotal(data.BID_PRICE, data.LOT_FEE_JSON).price == data.PAY_PRICE && data.receipt_vbank == 'Y' && data.PG_TRANS_ID" onclick="receiptPopup(this)"><span>현금영수증</span></button>
