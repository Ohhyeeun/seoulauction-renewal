...
app.controller('memHisPopCtl', function($scope, consts, common) {
	$scope.init = function(){
 		$d = {};
 		common.callAPI('/api/mypage/memberHistories',$d, function(data, status){
 	   		console.log(data);
 	   		$scope.custPayList = data["data"]["list"];
		});
	}
});
		...
		<div id="container" ng-controller="myPageCtl" >
