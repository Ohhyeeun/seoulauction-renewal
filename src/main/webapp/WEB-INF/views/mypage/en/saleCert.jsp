			...
			<fieldset>
				<div class="tbl_style01 m_tbl_z003 mt15">
					<table>
							...
							<td>
								<div class="fl_wrap type02">
									<div class="input_phone">
										...
										<p class="tbl_txt" ng-style="{'color': 'red', 'font-weight': 'bold'}">{{auth_exists}}</p>
						...
						<tr>
							<th scope="row" style="width:100px;"><label for="">{{auth_exists}}</label><span class="ico_essen"><span class="hidden">필수입력</span></span></th>
							<td>
								<div class="fl_wrap type02">
