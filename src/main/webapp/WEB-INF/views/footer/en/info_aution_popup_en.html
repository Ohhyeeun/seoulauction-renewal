                        ...
                        <div class="section-inner">
                            <div class="content-panel type_panel-infoaction_popup">
                                <div class="content-body">
                                    <p>Auto-refresh workaround</p>
                                    <ul>
                                        <li>
                                            <div class="">
                                                <ol class="tb1">
                                                    <li>1. Click Explorer Settings (usually a cogwheel)</li>
                                                    <li>2. Click Internet Options</li>
                                                    <li>3. Click General -> Browsing History -> Settings</li>
                                                    <li>4. Click every time I visit the webpage</li>
                                                    <li>5. OK (Save)</li>
                                                    <li>5. OK (Save)</li>
                                                </ol>
                                            </div>
                                        ...
                                        <li>
                                            <div class="img_02">
                                                <img src="/images/mobile/footer/popup_img_en.jpg">
                                            </div>
                                        </li>
                                    </ul>
