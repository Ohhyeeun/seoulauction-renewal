...
<head>
    ...
    <title>Auction Terms | Seoul Auction</title>
    <!-- //header -->
</head>
        ...
        <div class="sub-wrap pageclass">
            ...
            <div id="container">
                <div id="contents" class="contents">
                    ...
                    <section class="page_title-section">
                        <div class="section-inner full_size">
                            <div class="center-box">
                                <h2 class="page_title"><span class="th1">Auction Terms</span></h2>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="basis-section last-section terms-section">
                        <div class="section-inner">

                            <div class="content-panel type_panel-terms">
                                <div class="panel-header">
                                    <nav class="tab_move-bar js-tab_move">
                                        <ul>
                                            <li><a href="#terms_view-offline_term">Terms of Offline Korea Sale</a></li>
                                            <li><a href="#terms_view-online_term">Terms of Online Sale</a></li>
                                            <li><a href="#terms_view-hk_term">Terms of Hong Kong Sale</a></li>
                                            <li><a href="#terms_view-hk_guide">IMPORTANT NOTICES (Hong Kong Sale)</a></li>
                                        </ul>
                                    </nav>
                                </div>

                                <div class="panel-body">
                                    <article class="terms_view-area">
                                        <div class="area-inner">
                                            <div class="terms_view-box" id="terms_view-offline_term">
                                            ...
                                            <div class="terms_view-box" id="terms_view-online_term">
                                                <h3>Terms of Online Sale</h3>
                                                <p class="tb1">Please carefully review the provisions of these Auction Terms.<br>
                                            ...
                                            <div class="terms_view-box" id="terms_view-hk_term">
                                            ...
                                            <div class="terms_view-box" id="terms_view-hk_guide">
