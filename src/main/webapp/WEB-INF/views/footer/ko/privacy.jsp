                            ...
                            <div class="content-panel type_panel-privacy">
                                <div class="panel-header">
                                    ...
                                    <div class="privacy-info tb1">
                                        (주)서울옥션(이하 ‘회사’라 한다)는 정보통신망 이용촉진 및 정보보호에 관한 법률 및 개인정보 보호법에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립․공개합니다. 본 방침은 2019년 6월 1일부터 시행됩니다.
                                    </div>
                                </div>
                                    ...
                                    <article class="privacy_view-area">
                                        <div class="area-inner">
                                            <div class="privacy_view-box">
                                                ...
                                                <p class="tb1">
                                                    회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 관련 법률에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.<br><br>
                                                ...
                                                <p class="tb1">이 개인정보 처리방침은 2019. 6. 1. 부터 적용됩니다.</p>
                                            </div>
                                        </div>
                                    </article>
                                </div>
