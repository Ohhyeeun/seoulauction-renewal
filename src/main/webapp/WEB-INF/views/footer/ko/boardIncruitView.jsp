                                ...
                                <div class="panel-header">
                                    <article class="incruit_view-header view-header">
                                        ...
                                        <div class="button-area">
                                            <a class="btn btn_default" href="#" role="button"><span>입사지원서</span><i class="icon-file_down"></i></a>
                                            <a class="btn btn_point" href="#" role="button"><span>지원</span></a>
                                        </div>
                                    </article>
                                </div>
