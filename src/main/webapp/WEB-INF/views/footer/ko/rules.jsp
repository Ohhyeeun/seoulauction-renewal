...
<head>
    ...
    <title>내부정보관리규정 | Seoul Auction</title>
    <!-- //header -->
</head>
        ...
        <div class="sub-wrap pageclass type-pagemain">
            ...
            <div id="container">
                <div id="contents" class="contents">
                    ...
                    <section class="page_title-section">
                        <div class="section-inner full_size">
                            <div class="center-box">
                                <h2 class="page_title"><span class="th1">내부정보관리규정</span></h2>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="basis-section last-section rules-section">
                        <div class="section-inner">

                            <div class="content-panel type_panel-rules">
                                <div class="panel-body">
                                    <article class="rules_view-area">
                                        <div class="area-inner">
                                            <div class="rules_view-box">
                                                <h3>제1장 총칙</h3>
                                                <h4>제1조(목적)</h4>
                                                <p class="tb1">
                                                ...
                                                <h4>제2조(용어의 정의)</h4>
                                                <p class="tb1">
                                                    ①이 규정에서 "내부정보"라 함은 한국거래소(이하 “거래소”라 한다)의 코스닥시장 공시규정(이하 “공시규정”이라 한다) 제1편에 의한 공시의무사항과 그 밖에 회사의 경영 또는 재산상황 등에 관한 것으로서 투자자의 투자판단에 영향을 미칠 수 있는 사항을 말한다.<br>
                                                    ②이 규정에서 "공시책임자"라 함은 공시규정 제2조제4항에 따라 회사를 대표하여 신고업무를 수행할 수 있는 자를 말한다.<br>
                                                ...
                                                <h4>제4조(내부정보의 관리)</h4>
                                                <p class="tb1">
                                                    ①임원․직원은 업무상 알게 된 회사의 내부정보를 엄중히 관리하여야 하고, 업무상 필요한 경우를 제외하고는 내부정보를 사내 또는 사외에 유출하여서는 아니 된다.<br>
                                                    ②대표이사는 내부정보 및 그와 관련된 문서 등의 보관, 전달, 파기 등에 관한 구체적인 기준을 정하는 등 내부정보관리를 위해 필요한 조치를 취하여야 한다.<br>
                                                    ※ 집행임원을 둔 회사의 경우에는 ‘대표이사’를 ‘대표집행임원’으로 수정한다. 이하 같다.
                                                </p>
                                                <h4>제5조(공시책임자)</h4>
                                                <p class="tb1">
                                                    ①대표이사는 공시책임자를 정하여 지체 없이 거래소에 신고하여야 한다. 공시책임자를 변경한 때에도 또한 같다.<br>
                                                ...
                                                <h4>제6조(공시담당자)</h4>
                                                <p class="tb1">
                                                    ①대표이사는 공시담당자를 정하여 지체 없이 거래소에 신고하여야 한다. 공시담당자를 변경한 때에도 또한 같다.<br>
                                                    ...
                                                    4. 그 밖에 대표이사 또는 공시책임자가 필요하다고 인정한 사항<br>
                                                </p>

                                                <h4>제7조(내부정보의 집중)</h4>
                                                <p class="tb1">
                                                    ① 임원 및 각 부서의 장은 다음 각 호의 어느 하나에 해당하는 경우에 적시에 공시책임자에게 그에 관한 정보를 제공하여야 한다.<br>
                                                ...
                                                <h4>제7조의3(종속회사 내부정보의 집중) </h4>
                                                <p class="tb1">
                                                    ① 회사는 공시의무사항과 관련된 내부정보가 종속회사에서 발생하거나 발생이 예상되는 경우 종속회사로 하여금 그 내용을 회사의 공시책임자 또는 공시담당자에게 즉시 통지하도록 하여야 한다.<br>
                                                    ② 회사는 제1항에 따른 공시의무사항과 관련된 내부정보를 효율적으로 관리하기 위하여 종속회사에 공시관련 정보를 관리하는 자를 두도록 하며, 이를 지정하거나 변경하는 경우 회사의 공시책임자 또는 공시담당자에게 즉시 통보하도록 하여야 한다.<br>
                                                    ③ 회사는 종속회사에게 공시업무에 필요한 범위에서 관련 자료의 제출을 요구할 수 있다.
                                                </p>
                                                <h4>제8조(내부정보의 사외제공)</h4>
                                                <p class="tb1">
                                                    ①임원․직원이 업무상의 이유로 회사의 거래상대방․외부감사인․대리인, 회사와 법률자문․경영자문 등의 자문계약을 체결하고 있는 자 등에 대하여 불가피하게 내부정보를 제공해야 하는 경우 공시책임자에게 이에 관한 사항을 보고하여야 한다.<br>
                                                    ②제1항의 경우 공시책임자는 관련 내부정보의 비밀유지에 관한 계약을 체결하는 등 필요한 조치를 취하여야 한다.<br>
                                                ...
                                                <h4>제9조의2(공시대상의 확인)</h4>
                                                <p class="tb1">
                                                    이 규정에 따라 공정공시를 포함한 공시의무사항 해당 여부를 판단함에 있어서 공시규정 제6조제1항제4호에 의한 주가 또는 투자판단에 중대한 영향을 미치거나 미칠 수 있는 사항도 포함되도록 주의하여야 한다.
                                                </p>
                                                <h4>제10조(공시의 실행)</h4>
                                                <p class="tb1">
                                                    ①공시담당자는 제9조에 정한 공시사항이 발생한 경우 필요한 내용을 작성하고 필요한 서류 등을 갖추어 공시책임자에게 보고하여야 한다.<br>
                                                    ②공시책임자는 제1항의 내용과 서류 등이 관련법규에 위반되지 않는지의 여부를 검토하여 이를 대표이사에게 보고한 후 공시하여야 한다.
                                                </p>
                                                <h4>제10조의2(공시의 신속한 이행)</h4>
                                                <p class="tb1">
                                                    공시책임자는 제9조에 따른 공시사항이 발생한 경우 공시규정에 따른 공시시한 전이라도 해당 내부정보가 적시에 공시될 수 있도록 최선의 노력을 다하여야 한다.
                                                </p>
                                                <h4>제11조(공시 후의 사후조치)</h4>
                                                <p class="tb1">
                                                    공시책임자와 공시담당자는 공시한 내용에 오류나 누락이 있거나 취소 또는 변경하고자 하는 경우 지체 없이 공시규정 제30조에 따라 정정공시하는 등 이를 시정하기 위한 조치를 취하여야 한다.
                                                </p>
                                                <h4>제12조(언론사의 취재 등)</h4>
                                                <p class="tb1">
                                                    ① 언론사 등으로부터 회사에 대한 취재요청이 있는 경우 원칙적으로 공시책임자가 이에 응한다. 필요한 경우 관련 부서의 임원․직원이 취재에 응하게 할 수 있다.<br>
                                                    ② 회사가 언론사 등에 보도자료를 배포하고자 하는 경우 공시책임자와 협의하여야 한다.<br>
                                                    ③ 공시책임자는 제2항에 따라 배포하는 보도자료의 내용이 공정공시 대상에 해당하는 경우에는 보도자료 배포 전까지 공시하여야 한다.<br>
                                                    ④ 언론의 보도내용이 사실과 다르다는 것을 알게 된 임원․직원은 이를 공시책임자에게 보고 하여야 한다. 공시책임자는 관련 사항을 대표이사에게 보고하고 필요한 조치를 취하여야 한다.
                                                </p>
                                                <h4>제12조의2(보도내용의 확인)</h4>
                                                <p class="tb1">
                                                    공시책임자․공시담당자 및 내부정보 발생 부서는 언론사 등의 회사 관련 보도내용을 일상적으로 확인하여 사실과 다른 내용이 있는 경우 이를 시정하기 위한 조치를 취하여야 한다.
                                                </p>
                                                <h4>제13조(기업설명회)</h4>
                                                <p class="tb1">
                                                    ① 대표이사는 IR활동이 코스닥시장상장법인의 경영책무임을 인식하고, 자발적․지속적으로 기업설명회를 개최하여 투자관계자와 신뢰를 구축하기 위해 노력하여야 한다.<br>
                                                    ② 회사의 경영내용, 사업계획 및 전망 등에 대한 기업설명회는 공시책임자와 협의하여 개최하여야 한다.<br>
                                                    ③ 공시책임자 또는 공시담당자는 기업설명회의 일시, 장소, 설명회 내용 등을 개최 전일까지 공시하고, 관련 자료를 설명회 개최 전까지 거래소 공시제출시스템에 게재하여야 한다.<br>
                                                    ④ 회사의 모든 임원·직원은 기업설명회 과정에서 공정공시 대상정보 중 사전에 공시되지 않은 사항이 공개되지 않도록 주의하여야 한다.
                                                </p>
                                                <h4>제13조의2(풍문)</h4>
                                                <p class="tb1">
                                                    ① 공시책임자는 시장에 풍문이 유포되어 있는 경우 관련 사업부서에 대한 의견조회 등을 통해 풍문 내용의 사실 여부 및 내부정보에 해당하는지 여부 등을 확인하여야 한다.<br>
                                                    ② 제1항에 따른 확인 결과 당해 풍문이 공시규정에 따른 공시의무사항에 해당하는 경우 관련정보를 공시하여야 한다.
                                                </p>
                                                <h4>제13조의3(정보제공 요구)</h4>
                                                <p class="tb1">
                                                    ① 주주 및 이해관계자 등으로부터 회사와 관련한 정보공개를 요구받은 경우 공시책임자는 당해 요구의 적법성 등을 검토하여 관련 정보를 제공할 것인지 여부를 결정하여야 한다.<br>
                                                    ② 공시책임자는 정보의 제공 여부를 결정하기 위하여 제공을 요구받은 정보가 투자자의 투자판단 및 주가에 영향을 미칠 수 있는지 여부에 대하여 법무담당 부서 또는 외부 법률전문가 등의 의견을 청취할 수 있다.<br>
                                                    ③ 제1항의 결정에 따라 정보를 제공하는 경우에는 제12조제3항을 준용한다.
                                                </p>

                                                <h3>제4장 내부자 거래 등에 대한 규제</h3>
                                                <h4>제14조(단기매매차익의 반환)</h4>
                                                <p class="tb1">
                                                    ①임원과 법 제172조제1항 및 법 시행령 제194조가 정하는 직원은 법 제172조제1항의 특정증권등(이하 "특정증권등"이라 한다)을 매수한 후 6개월 이내에 매도하거나 특정증권등을 매도한 후 6개월 이내에 매수하여 이익을 얻은 경우에 그 이익(이하 "단기매매차익"이라 한다)을 회사에 반환하여야 한다.<br>
                                                    ②회사의 주주(주권 외의 지분증권 또는 증권예탁증권을 소유한 자를 포함한다. 이하 이 조에서 같다)가 회사에 대하여 제1항에 따른 단기매매차익을 얻은 자에게 단기매매차익의 반환청구를 하도록 요구한 경우 회사는 그 요구를 받은 날부터 2개월 이내에 필요한 조치를 취하여야 한다.<br>
                                                ...
                                                <h4>제17조(교육)</h4>
                                                <p class="tb1">
                                                    ① 공시책임자와 공시담당자는 공시규정 제36조 및 제44조제5항에 따른 공시업무에 관한 교육 등을 이수하여야 하고, 공시책임자는 교육내용을 관련 임원․직원에게 알려야 한다.<br>
                                                ...
                                                <h4>제19조(규정의 공표)</h4>
                                                <p class="tb1">이 규정은 회사의 홈페이지에 공표한다. 규정을 개정한 때에도 또한 같다.</p>
                                            </div>
                                        </div>
                                    </article>
                                </div>
