                                                        ...
                                                        <ul class="">
                                                            <li>
                                                                <div class="trp checkbox-box">
                                                                    ...
                                                                    <i></i>
                                                                    <label for="checkbox_all1">본인은 서울옥션 경매약관(<span><a href="/footer/terms" target="terms">바로가기</a></span>)을 모두 읽고<br class="only-pc"> 이해하였으며, 그 적용에 동의합니다.</label>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="trp checkbox-box">
                                                            ...
                                                            <li>
                                                                <div class="trp checkbox-box">
                                                                    ...
                                                                    <i></i>
                                                                    <label for="checkbox_all3">낙찰자는 후 7일 이내(낙찰가 3억원 이상인 경우 21일 이내)에<br class="only-pc"> 구매수수료를 포함한 금액을 입금하여야 합니다. 구매수수료는 낙찰금액의 18%(부가세 별도)입니다.</label>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="trp checkbox-box">
