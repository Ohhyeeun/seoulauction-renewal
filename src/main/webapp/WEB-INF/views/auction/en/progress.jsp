                                ...
                                <div class="tab-wrap">
                                    <div class="tab-area type-left">
                                        <ul class="tab-list js-list_tab">
                                            <li class="active"><a href="#tab-cont-1"><span>Current</span></a></li>
                                            <li><a href="/auction/upcoming"><span>Upcoming</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="info-box">
                                                            ...
                                                            <dl>
                                                                ...
                                                                <dd>
                                                                    ...
                                                                    <ng:template ng-if="['online','online_zb'].indexOf(auction.SALE_KIND_CD) > -1">Sequential Closing</ng:template>
                                                                </dd>
                                                            </dl>
                                                        </div>
                                                        <div class="btn-box">
                                                            <button class="btn btn_default" ng-click="goProgressAuction(auction.SALE_KIND_CD, auction.SALE_NO);"><span>View Auction</span></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </article>
