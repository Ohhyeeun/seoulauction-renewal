                                ...
                                <div class="tab-wrap">
                                    <div class="tab-area type-left">
                                        <ul class="tab-list js-list_tab">
                                            <li><a href="/auction/progress"><span>Current</span></a></li>
                                            <li class="active"><a href="#tab-cont-2"><span>Upcoming</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <article class="item-article">
                                                ...
                                                <div class="typo-area">
                                                    <div class="product_info">
                                                        ...
                                                        <div class="btn-box">
                                                            <button class="btn btn_default" ng-click="goUpcomingAuction(auction.SALE_NO);"><span>Upcoming Auction</span></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </article>
