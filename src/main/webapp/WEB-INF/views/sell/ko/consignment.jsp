                                            ...
                                            <li>
                                                <div class="inner">
                                                    ...
                                                    <dl>
                                                        ...
                                                        <dd class="tb1">
                                                            서울옥션은 수많은 경매를 통해 국내 및 해외 작가의 다양한 신기록을 보유하고 있습니다. 한국작가 중 최고가격을 보유한 김환기는 물론 이중섭, 박수근의 신기록 모두 서울옥션에서 탄생했습니다. 백자대호, 민화, 서화 등 다양한 한국 고미술품도 서울옥션에서 뛰어난 가치를 인정받았습니다.
                                                        </dd>
                                                    </dl>
                                                </div>
                                            </li>
                                    ...
                                    <div class="article-body">
                                                    ...
                                                    <div class="item-body">
                                                        ...
                                                        <div class="refer">
                                                            <ul class="dot_list tb2">
                                                                ...
                                                                <li>
                                                                    답변은 <a href="/mypage/inquiryForm" class="ft_sb colorB2">마이페이지 > 1:1문의</a>에서 확인하실 수 있습니다.
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="cont-sub">
                                            ...
                                            <div class="sell_item-area">
                                                <div class="sell-box">
                                                    <div class="item-inner">
                                                        <ul class="contract_step">
                                                            <li>
                                                                <div class="icon-box">
                                                                    <i class="icon-sell_contract_1"></i>
                                                                </div>
                                                                <dl class="">
                                                                    <dt>01</dt>
                                                            ...
                                                            <li>
                                                                <div class="icon-box">
                                                                    <i class="icon-sell_contract_2"></i>
                                                                </div>
                                                                <dl class="">
                                                                    <dt>02</dt>
                                                            ...
                                                            <li>
                                                                <div class="icon-box">
                                                                    <i class="icon-sell_contract_3"></i>
                                                                </div>
                                                                <dl class="">
                                                                    <dt>03</dt>
                                                                    <dd>실물 감정절차</dd>
                                                            ...
                                                            <li>
                                                                <div class="icon-box">
                                                                    <i class="icon-sell_contract_4"></i>
                                                                </div>
                                                                <dl class="">
                                                                    <dt>04</dt>
